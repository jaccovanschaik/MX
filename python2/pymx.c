        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyString_FromString(mxEffectiveName(mx_name));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyString_FromString(mxEffectiveHost(mx_host));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyInt_FromLong(mxEffectivePort(mx_name));
...
static PyObject *MX_MyName(MXObject *self)
{
    ...
    result = PyString_FromString(mxMyName(self->mx));
...
static PyObject *MX_Name(MXObject *self)
{
    ...
    result = PyString_FromString(mxName(self->mx));
...
static PyObject *MX_Host(MXObject *self)
{
    ...
    result = PyString_FromString(mxHost(self->mx));
...
static PyObject *MX_Port(MXObject *self)
{
    ...
    result = PyInt_FromLong(mxPort(self->mx));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyInt_FromLong(mxRegister(self->mx, msg_name));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyString_FromString(mxMessageName(self->mx, msg_type));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyString_FromString(mxComponentName(self->mx, fd));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    return PyInt_FromLong(mxSubscribe(self->mx, msg_type, subscribe_cb, handler));
}
...
static PyObject *MX_Cancel(MXObject *self, PyObject *args, PyObject *kwds)
{
    ...
    return PyInt_FromLong(mxCancel(self->mx, msg_type));
}
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyInt_FromLong(mxConnectionNumber(self->mx));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyInt_FromLong(mxProcessEvents(self->mx));
        ...
        PyObject *args, PyObject *kwds)
{
    ...
    result = PyString_FromString(error_msg);
...
PyMODINIT_FUNC initmx(void)
{
    ...
    m = Py_InitModule3("mx", module_methods, "MX module.");
